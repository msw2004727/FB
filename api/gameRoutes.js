...
const cultivationRoutes = require('./gameplay/cultivationRoutes'); // 【核心新增】
...
router.use('/cultivation', cultivationRoutes); // 【核心新增】 e.g., /api/game/cultivation/start
