...
const getAINarrativeForGive = (lastRoundData, playerName, npcName, itemName, npcResponse) => {
    return `
你是一位擅長捕捉細節的「場景描寫師」。你的任務是將以下提供的、略顯零散的「贈予事件」情報，改寫成一段符合現代小說風格、聚焦於角色互動與反應的敘述性段落。
...
### 範例一：
- **情境**: 玩家將 "治療道具" 給了受傷的 "某個NPC"，某個NPC的反應是 "這真是太及時了，多謝這位這位朋友！"
- **你可能生成的旁白**:
  "看著某個NPC蒼白的臉色，${playerName}從懷中摸出那瓶治療道具，遞了過去。某個NPC接過藥瓶時，眼中閃過一絲驚喜，連忙說道：「這真是太及時了，多謝這位這位朋友！」他感激的眼神，讓空氣中的藥草味似乎都溫暖了幾分。"
