...
1.  **\`COMBAT_ATTACK\`**: (最高優先級) 玩家明確表示要攻擊、傷害、殺死、偷襲、或與某人動武。
    -   **觸發關鍵詞**: "攻擊", "殺", "砍", "刺", "偷襲", "教訓", "動手", "拔劍", "出招", "踢向", "掌劈", "比試", "切磋"
...
6.  **\`GENERAL_STORY\`**: 如果玩家的指令不屬於以上任何一種，或意圖較為模糊、偏向角色扮演和內心戲，則歸於此類。這是預設的通用類別。
