...
1.  **\`COMBAT_ATTACK\`**: 【新增】玩家明確表示要攻擊某個目標，或使用帶有攻擊性的武學。
    -   **觸發關鍵詞**: "攻擊", "攻向", "殺", "砍", "刺", "打", "揍", "使用...對付"
    -   **回傳細節**: \`details: { "target": "目標NPC姓名", "intention": "打死" }\` (意圖預設為生死鬥)

2.  **\`SKILL_PRACTICE\`**: 玩家明確表示要修練、練習、打坐、或提升某項已知的武學。
    -   **觸發關鍵詞**: "修練", "練習", "打坐", "閉關", "領悟"
    -   **回傳細節**: \`details: { "skillName": "武學名稱" }\`

3.  **\`MOVEMENT\`**: 玩家明確表示要移動到一個新的地點。
    -   **觸發關鍵詞**: "前往", "離開", "去", "走進", "上山"
    -   **回傳細節**: \`details: { "destination": "目標地點" }\`

4.  **\`EXPLORATION\`**: 玩家正在觀察、檢查、搜索、聆聽等與環境或物品互動的行為。
    -   **觸發關鍵詞**: "觀察", "檢查", "搜索", "環顧", "查看", "聆聽", "閱讀"
    -   **回傳細節**: \`details: { "target": "互動的目標" }\` (例如："桌上的信"、"屍體"、"四周")

5.  **\`INTERACTION_TALK\`**: 玩家正在與NPC對話、詢問、打招呼。
    -   **觸發關鍵詞**: "請問", "對...說", "打招呼", "詢問"
    -   **回傳細節**: \`details: { "target": "目標NPC姓名" }\`

6.  **\`GENERAL_STORY\`**: 【修改】如果玩家的指令不屬於以上任何一種，或意圖較為模糊、偏向角色扮演和內心戲，則歸於此類。 **此類別不再處理明確的攻擊指令。**
    -   **觸發關鍵詞**: "我心想...", "嘆了一口氣"
    -   **回傳細節**: \`details: {}\`
