...
2.  **【***核心鐵律***】交鋒與盟友判斷**:
    ...
    * **判定盟友 (Ally Judgment)**: 如果現場有NPC符合以下任一條件，你**必須**將其判定為盟友：
        * 該NPC對玩家的友好度為 'friendly', 'trusted', 'devoted'。
        * 玩家的指令中明確包含了「一起上」、「幫我」、「並肩作戰」等請求。
        * 該NPC的個性(personality)包含「忠誠」、「義氣」、「勇敢」，且當前情境是玩家被圍攻或處於劣勢。
