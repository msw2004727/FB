...
- Restored NPC attack intention button data-intention values in scripts/interactionHandlers.js to the backend whitelist values (���R, �аV, ����) after they were corrupted to question marks, which caused /initiateCombat to return �L�Ī��ʤ�N�ϡC`r
